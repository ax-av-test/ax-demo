...
default_args={
    "owner": "av_vidyakin@mail.ru,Open in Cloud IDE",
}

@dag(
    default_args=default_args,
    schedule=None,
    start_date=pendulum.from_format("2024-08-22", "YYYY-MM-DD"),
    catchup=False,
    owner_links={
        "av_vidyakin@mail.ru": "mailto:av_vidyakin@mail.ru",
        "Open in Cloud IDE": "https://cloud.astronomer.io/cm055k7mz052901kf9yo17n1k/cloud-ide/cm056o1b805gx01mactah21vm/cm056o1nh05iy01kolmbf9ggi",
    },
)
